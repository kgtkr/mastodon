I will run `git status` to check if there are other conflicted files or if this is the only file that requires attention.
...
class ActivityPub::ProcessAccountService < BaseService
  ...
  def set_fetchable_attributes!
    ...
    begin
      ...
      @account.header_remote_url = header_url || '' unless true
